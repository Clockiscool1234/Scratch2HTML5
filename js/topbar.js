function createTBmenus(){
	...
	const languageButton = createIconMenu("languageButton", "images/674_assets.Resources_languageButtonOff.png", "images/547_assets.Resources_languageButtonOn.png", [{"name":"English","func":unimplementedDialog}], 19, 19)
	const fileMenu = createMenu("fileMenu", "File", [{"name":"New","func":unimplementedDialog},{"name":"Upload from your computer","func":unimplementedDialog},{"name":"Download to your computer","func":unimplementedDialog}])
	const editMenu = createMenu("editMenu", "Edit", [{"name":"Undelete","func":unimplementedDialog},{"name":"Small stage layout","func":unimplementedDialog},{"name":"Turbo mode","func":unimplementedDialog}])
