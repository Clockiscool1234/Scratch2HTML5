function createTBmenus(){
	...
	const languageButton = createIconMenu("languageButton", "images/674_assets.Resources_languageButtonOff.png", "images/547_assets.Resources_languageButtonOn.png", ["1","2","3"], 19, 19)
	const fileMenu = createMenu("fileMenu", "File", ["New","Upload from your computer","Download to your computer"])
	const editMenu = createMenu("editMenu", "Edit", ["Undelete","Small stage layout","Turbo mode"])
